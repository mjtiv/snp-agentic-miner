...
A deterministic + agentic pipeline for SNP annotation,
...
This file contains the LLM-assisted interpretation of each analyzed SNP, including biological plausibility, mechanism category, priority ranking, and a short explanatory rationale.

---

## Example Output

Below is an example of the final variant interpretation table generated by the pipeline.

![Example Variant Interpretation Output](example_llm_analysis_output.png)

The table summarizes LLM-assisted interpretation of each SNP, highlighting variants that may have stronger biological relevance to the disease of interest.
